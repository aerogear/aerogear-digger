...
XC_VERSION = ""                       // Provide a value like 8.3 to use a specific XCode version.
...
// RHMAP specific values. RHMAP currently sends build config type all lower case. It is handled here as case matters for Xcode.
